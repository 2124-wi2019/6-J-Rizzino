...
{
    console.log(lottoPicks[n]);
    //I included a console.log of the lottoPicks array because I was checking if winning numbers were getting matched using the switch structure.
    switch (n) {
        case 22:
